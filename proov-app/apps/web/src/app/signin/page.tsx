...
export default function SignInPage() {
  ...
  // on button click — popup blockers kill any popup opened after async delays.
  useEffect(() => {
  ...
  const triggerConnect = async (loginProvider = 'google') => {
    setConnecting(true);
    // No cleanup awaited here — it already ran on mount.
    // Calling connectTo as close to the click as possible prevents popup blocking.
